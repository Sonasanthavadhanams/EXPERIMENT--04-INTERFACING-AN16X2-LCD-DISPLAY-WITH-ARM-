...
{
    Lcd_cursor(&lcd,0,1);
    Lcd_string(&lcd,"SONA S \n");

    Lcd_cursor(&lcd,1,1);
    Lcd_string(&lcd,"212224110049\n");
}
...
## Output screen shots of proteus  :
 ...
 <img width="1156" height="870" alt="image" src="https://github.com/user-attachments/assets/61e78854-4c2b-4f8d-bcdf-18b04efa4394" />

 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 
 <img width="1457" height="923" alt="image" src="https://github.com/user-attachments/assets/201cac8b-f5f4-466c-bc21-a372d63a8fb4" />
